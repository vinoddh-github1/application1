...
aws ecr get-login-password --region us-east-2 --profile vinodhpersonal | docker login --username AWS --password-stdin 849440486996.dkr.ecr.us-east-2.amazonaws.com
